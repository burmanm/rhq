...
<table width="400" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="BlockContent" colspan="2">
      ...
      <html:link page="/coregui/CoreGUI.html#Dashboards"><fmt:message key="error.Error.DashboardLink"/></html:link>
      <html:link page="/coregui/CoreGUI.html#Inventory/Resources/AllResources"><fmt:message key="error.Error.ResourceHubLink"/></html:link>
      </p>
